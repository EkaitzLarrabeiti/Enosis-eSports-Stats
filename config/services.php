...
return [
    ...
    */
    ...
    'iracing' => [
        ...
        'scope' => env('IRACING_SCOPE', 'iracing.auth'),
        'pw_client_id' => env('IRACING_PW_CLIENT_ID'),
        'pw_client_secret' => env('IRACING_PW_CLIENT_SECRET'),
        'pw_scope' => env('IRACING_PW_SCOPE', env('IRACING_SCOPE', 'iracing.auth')),
