    ...
    <div class="bg-black/50 backdrop-blur-sm p-8 border border-gray-800/30 rounded-xl shadow-lg w-full max-w-md relative z-10">
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="name" name="name" id="name" required class="w-full px-3 bg-white/25 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300">
            </div>
            <div>
                <label for="nickname" class="block mb-1 font-medium text-white">Nickname</label>
                <input type="nickname" name="nickname" id="nickname" required class="w-full px-3 bg-white/25 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300">
            </div>
            <div>
            ...
            <div>
                <label for="password_confirmation" class="block mb-1 font-medium text-white">Confirmar contraseña</label>
