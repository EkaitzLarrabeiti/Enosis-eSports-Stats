<footer class="w-full border-t border-gray-800/70 bg-black/75 backdrop-blur-sm mt-auto">
    <div class="max-w-6xl mx-auto px-4 md:px-6 py-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="footer-socials flex items-center gap-4">
            <a href="https://x.com/e_enosis"
               class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-700/70 bg-white/5 transition hover:bg-white/10"
               target="_blank"
